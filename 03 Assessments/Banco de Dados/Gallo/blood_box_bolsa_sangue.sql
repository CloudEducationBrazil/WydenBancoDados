...
CREATE TABLE `bolsa_sangue` (
  ...
  `local_armazenamento` varchar(25) NOT NULL,
  `id_coleta` int DEFAULT NULL,
  PRIMARY KEY (`id_bolsa`),
  KEY `id_coleta_idx` (`id_coleta`),
  CONSTRAINT `id_coleta` FOREIGN KEY (`id_coleta`) REFERENCES `coleta_sangue` (`id_funcionario_coleta`)
...
-- Dump completed on 2023-10-26 20:16:56
